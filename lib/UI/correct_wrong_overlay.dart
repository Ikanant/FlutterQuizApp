          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                angle: _iconAnimation.value * 2 * PI, // goes from 0 0.1 ... 1.... 2*PI it's a full rotation
            ...
            new Text(widget._isCorrect ? "Correct!" : "Fail!", style: new TextStyle(color: Colors.white, fontSize: 30.0),)
          ]
        )
      ),
    );
